...
[![Version](https://img.shields.io/badge/Version-1.0.0-orange.svg)](https://github.com/TsuyoshiKashiwazaki/wp-plugin-kashiwazaki-seo-auto-description/releases)

投稿・固定ページ・カスタム投稿・メディアから自動でSEO最適化されたメタディスクリプションを生成するWordPressプラグイン

> 🎯 **AI技術でSEOを自動化。OpenAI GPTが最適なメタディスクリプションを瞬時に生成。**

## 主な機能

- **🤖 AI自動生成**: OpenAI GPTモデルによる高品質なメタディスクリプション生成
- **📝 幅広い対応**: 投稿・固定ページ・カスタム投稿タイプ・メディアファイルに対応
- **⚙️ 柔軟な設定**: 文字数指定（80-500文字）と複数のGPTモデルから選択
...
1. **投稿・固定ページの編集画面で**:
   ...
   - 気に入った内容を「📋 descriptionをコピー」でクリップボードにコピー
...
**🔍 Keywords**: WordPress, SEO, メタディスクリプション, OpenAI, GPT, 自動生成, プラグイン
